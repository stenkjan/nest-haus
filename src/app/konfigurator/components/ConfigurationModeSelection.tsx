...
export default function ConfigurationModeSelection({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Content container */}
      <div className="relative z-10 w-full max-w-5xl 2xl:max-w-[90rem] 3xl:max-w-[135rem] mx-auto px-4 sm:px-6 lg:px-8">
        {/* Title */}
        <h2 className="text-2xl md:text-3xl lg:text-4xl 2xl:text-6xl 3xl:text-8xl font-normal text-gray-900 mb-8 2xl:mb-16 3xl:mb-24 text-center">
          Zwei Wege zum Ziel
        </h2>

        {/* Main box */}
        <div className="rounded-3xl shadow-lg overflow-hidden bg-[#F4F4F4] w-full p-8 md:p-12 2xl:p-24 3xl:p-36">
          {/* Two selection boxes */}
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 2xl:gap-12 3xl:gap-16 mb-6 2xl:mb-12 3xl:mb-16">
            {/* Left box - Mit Konfiguration */}
            <div
              className={`box_selection flex flex-col justify-center min-h-[12rem] 2xl:min-h-[20rem] 3xl:min-h-[30rem] border rounded-[1.5rem] 3xl:rounded-[2rem] px-6 py-8 2xl:px-14 2xl:py-16 3xl:px-20 3xl:py-24 cursor-pointer transition-all duration-200 ${
                selectedMode === "with"
            ...
            >
              <h3 className="text-xl md:text-2xl 2xl:text-4xl 3xl:text-6xl font-normal text-gray-900 mb-4 2xl:mb-8 3xl:mb-12 text-center">
                Mit Konfiguration
              </h3>
              <p className="text-base md:text-lg 2xl:text-2xl 3xl:text-3xl text-gray-700 text-center leading-relaxed">
          ...
          <p className="text-sm 2xl:text-lg 3xl:text-2xl text-gray-500 text-center mb-6 2xl:mb-10 3xl:mb-14">
          ...
          <div className="flex justify-center">
            <Button
              ...
              className={`2xl:text-2xl 2xl:px-14 2xl:py-6 3xl:text-3xl 3xl:px-20 3xl:py-8 ${
