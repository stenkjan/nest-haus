...
const PlanungspaketeDialog: React.FC<PlanungspaketeDialogProps> = ({
  ...
  const { configuration, updateSelection, removeSelection } = useConfiguratorStore();
  ...
  const handleConfirmSelection = () => {
    if (selectedPackage) {
      const selectedPlanningPackage = PLANNING_PACKAGES.find(pkg => pkg.value === selectedPackage);
  ...
  return (
    <Dialog isOpen={isOpen} onClose={onClose} transparent={true} className="p-0">
      <div className="relative w-full h-full flex items-center justify-center">
        ...
        <div 
          className="relative w-[95vw] h-[90vh] md:h-[85vh] overflow-y-auto pt-1 pb-1 md:pt-2 md:pb-2 px-1 md:px-1 flex justify-center items-start mt-[10vh] md:mt-[5vh]"
                  ...
                  <div className="flex flex-col gap-4">
                    <div>
                      <p className="text-xs sm:text-sm text-gray-700 mb-3 leading-snug">
                        Wir konzentrieren uns darauf, alle standardisierten Arbeitsprozesse zu optimieren und <span className="font-bold">höchste Qualität zu fairen Preisen</span> sicherzustellen. Darauf aufbauend machst <span className="font-bold">du dein Nest. Individuell.</span>
                      </p>
                      <p className="text-[13px] sm:text-base text-gray-700 mb-3 leading-snug">
                        Unsere <span className="font-bold">Planungspakete</span> bieten dir die perfekte Unterstützung für dein Bauvorhaben – von der <span className="font-bold">Grundplanung bis hin zur kompletten Baubegleitung</span> mit Innenraumkonzept.
                      </p>
                    </div>
                    <div className="space-y-2">
                      <div>
                        <h4 className="font-semibold text-[11px] text-gray-700 mb-0">Professionelle Planung</h4>
                        <p className="text-[11px] text-gray-400 leading-tight">
                          Einreichplanung, Fachberatung und Baubegleitung für einen reibungslosen Bauprozess.
                        </p>
                      </div>
                      <div>
                        <h4 className="font-semibold text-[11px] text-gray-700 mb-0">Technische Expertise</h4>
                        <p className="text-[11px] text-gray-400 leading-tight">
                          HKLS-Planung und Gebäudetechnik für optimale Energieeffizienz und Komfort.
                        </p>
                      </div>
                      <div>
                        <h4 className="font-semibold text-[11px] text-gray-700 mb-0">Individuelle Gestaltung</h4>
                        <p className="text-[11px] text-gray-400 leading-tight">
                          Interiorkonzept und Möblierungsvorschläge für dein persönliches Traumhaus.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="w-full md:flex-1 md:min-w-[260px] md:max-w-[540px] flex flex-col px-2 sm:px-4 md:pl-8 md:pr-4 lg:pl-12 lg:pr-0 pb-4 mt-4 md:mt-[2vh]">
                  <div className="space-y-3 sm:space-y-4">
                    ...
                    <div className="flex justify-center mt-4">
                      ...
                      >
                        {selectedPackage ? 'Paket auswählen' : 'Ohne Paket fortfahren'}
                      </Button>
                    </div>
                  </div>
                </div>
