...
export const metadata: Metadata = {
  ...
  description:
    "Planen Sie Ihr Traumhaus mit unserem Konfigurator. Verschiedene Module, Materialien und Ausstattungen. Sofort Preis kalkulieren!",
  keywords:
  ...
  twitter: {
    ...
    title: "NEST-Haus Konfigurator | Ihr Traumhaus planen",
    description:
      "Gestalten Sie Ihr individuelles Modulhaus mit unserem interaktiven Konfigurator.",
