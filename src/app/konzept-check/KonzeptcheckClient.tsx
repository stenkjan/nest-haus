            ...
            customData={[
              {
                ...
                subtitle: "",
                description:
                  "<span class='text-nest-gray'>Mit dem </span><span class='text-black'>Konzept-Check</span><span class='text-nest-gray'> erhältst du eine </span><span class='text-black'>Analyse deines Grundstücks</span><span class='text-nest-gray'>, welche dir einen Überblick und eine </span><span class='text-black'>rechtssichere Auskunft</span><span class='text-nest-gray'> über alle vorherrschenden </span><span class='text-black'>Vorschriften, Gesetze und Bebauungsmöglichkeiten</span><span class='text-nest-gray'> gibt. Diese Analyse ist die Grundlage für jedes Bauvorhaben und gibt dir eine klar strukturierte Übersicht über dein Baugrundstück.</span>\n\n<span class='text-nest-gray'>Solltest du dich nach dem </span><span class='text-black'>Konzept-Check</span><span class='text-nest-gray'> gegen Hoam entscheiden, dient dir diese </span><span class='text-black'>Analyse</span><span class='text-nest-gray'> auch als </span><span class='text-black'>Grundlage</span><span class='text-nest-gray'> für </span><span class='text-black'>alle anderen Bauvorhaben</span><span class='text-nest-gray'>.</span>",
            ...
            customData={[
              {
                ...
                subtitle: "",
                description:
                  "<span class='text-nest-gray'>Nach der Analyse deines Grundstücks erstellen wir einen </span><span class='text-black'>individuell</span><span class='text-nest-gray'> für dich </span><span class='text-black'>maßgeschneiderten Entwurfsplan</span><span class='text-nest-gray'>, der dir eine </span><span class='text-black'>konkrete Vorstellung</span><span class='text-nest-gray'> davon gibt, wie dein </span><span class='text-black'>®Hoam</span><span class='text-nest-gray'> auf </span><span class='text-black'>deinem Grundstück</span><span class='text-nest-gray'> aussehen könnte.</span>\n\n<span class='text-nest-gray'>Unser </span><span class='text-black'>Konfigurator</span><span class='text-nest-gray'> dient dafür, dass du ein </span><span class='text-black'>Preisgefühl</span><span class='text-nest-gray'> für </span><span class='text-black'>dein ®Hoam</span><span class='text-nest-gray'> bekommst und hilft uns dabei, eine </span><span class='text-black'>Ausgangsbasis</span><span class='text-nest-gray'> für deinen </span><span class='text-black'>individuellen Entwurf</span><span class='text-nest-gray'> festzulegen.</span>",
            ...
            customData={[
              {
                ...
                subtitle: "",
                description:
                  "<span class='text-nest-gray'>Da eine verlässliche Kostenplanung besonders wichtig ist, behalten wir die Kosten für dein Bauvorhaben jederzeit </span><span class='text-black'>transparent und nachvollziehbar</span><span class='text-nest-gray'> im Überblick.</span>\n\n<span class='text-nest-gray'>Mit dem </span><span class='text-black'>Grundstückscheck</span><span class='text-nest-gray'> und deiner </span><span class='text-black'>individuellen Entwurfsplanung</span><span class='text-nest-gray'> können wir eine </span><span class='text-black'>exakte Kostenplanung</span><span class='text-nest-gray'> für dich erstellen. So hast du den </span><span class='text-black'>Gesamtpreis stets klar im Blick</span><span class='text-nest-gray'>.</span>",
