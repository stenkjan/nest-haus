...
const analyticsQuerySchema = z.object({
    pageType: z.enum(['warenkorb', 'kontakt', 'hoam', 'entwurf', 'hoam-system', 'warum-wir']).optional(),
...
const trackingSchema = z.object({
    ...
    pageType: z.enum(['warenkorb', 'kontakt', 'hoam', 'entwurf', 'hoam-system', 'warum-wir']),
        ...
        switch (metric) {
            ...
            case 'overview':
                if (!pageType) {
                    ...
                    const allPages = ['warenkorb', 'kontakt', 'hoam', 'entwurf', 'hoam-system', 'warum-wir'];
