...
const initialProjectData = [
    ...
    { taskId: "4.1", task: "Video vom Hoam Bau einbinden (Video kommt 10.11)", responsible: "JWS", startDate: "2025-10-27", endDate: "2025-10-30", duration: 4, milestone: false, priority: "MITTEL", notes: "Platzhalter-Logik erstellen." },
