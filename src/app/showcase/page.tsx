      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          >
            ...
            From interactive card layouts to flexible grid systems, discover
            components that adapt beautifully to any screen size and use case.
          </motion.p>
        </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform group-hover:scale-[1.02]">
                <div className="p-8">
                  ...
                  <p className="text-gray-600 mb-6 leading-relaxed">
                    Interactive card layouts with responsive designs, glass
                    effects, lightbox views, and seamless navigation. Perfect
                    for showcasing content with style and elegance.
                  </p>
            ...
            <Link href="/showcase/grids" className="group block">
              <div className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform group-hover:scale-[1.02]">
                <div className="p-8">
                  ...
                  <p className="text-gray-600 mb-6 leading-relaxed">
                    Flexible grid layouts including 2x2 interactive grids, 3x1
                    layouts, and full-width image grids. Designed for optimal
