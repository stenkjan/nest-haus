...
import { ContentCards, ContentCardsLightbox, ContentCardsGlass, ContentCardsGlassLightbox, PricingCardsLightbox } from '@/components/cards';
      ...
      <div className="space-y-16">
        ...
        <section>
          <div className="max-w-7xl mx-auto px-4 text-center">
            <h1 className="text-4xl font-bold text-gray-900 mb-4">Card Components Showcase</h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Explore our collection of responsive card layouts: content cards, glass effects, lightbox views, and interactive elements. 
              Each component adapts beautifully to different screen sizes and interaction methods.
            </p>
          </div>
        </section>
