        ...
        {isMobile ? (
          ...
          <div className="space-y-6">
            ...
            <div className="px-4 md:px-8">
              ...
              >
                <p className={`text-sm md:text-base ${textColorClasses} leading-relaxed text-center`}>
                  {displayText}
                </p>
              </motion.div>
            </div>
            ...
            >
              ...
              >
                {/* Horizontal divider */}
                <div className={`h-px w-full ${backgroundColor === 'black' ? 'bg-gray-700' : 'bg-gray-300'} mb-6`}></div>
                
                {/* Technical specifications for mobile */}
                <div className="space-y-6">
                  <div>
                    <h4 className={`font-bold text-sm ${textColorClasses} mb-3`}>Technische Details</h4>
                    
                    {/* Aufbau a */}
                    <div className="mb-4">
                      <div className={`font-bold text-xs ${textColorClasses} mb-2`}>Aufbau a</div>
                      <div className={`text-xs ${textColorClasses} opacity-80 leading-relaxed space-y-1`}>
                        ...
                        <div>Sparren FJI 9x32cm + Steico Holzfaserdämmung</div>
                    ...
                    {/* Aufbau b */}
                    <div className="mb-4">
                      <div className={`font-bold text-xs ${textColorClasses} mb-2`}>Aufbau b</div>
                      <div className={`text-xs ${textColorClasses} opacity-80 leading-relaxed space-y-1`}>
                    ...
                    {/* Element c */}
                    <div className="mb-4">
                      <div className={`font-bold text-xs ${textColorClasses} mb-2`}>Element c</div>
                      <div className={`text-xs ${textColorClasses} opacity-80`}>Zugstab</div>
                    </div>

                    {/* Element d */}
                    <div className="mb-4">
                      <div className={`font-bold text-xs ${textColorClasses} mb-2`}>Element d</div>
                      <div className={`text-xs ${textColorClasses} opacity-80`}>Fundament</div>
                    </div>
                  </div>
                </div>
              </motion.div>
            ...
            {textPosition === 'left' ? (
              <>
                ...
                <motion.div
                  ...
                  transition={{ duration: 0.6 }}
                >
                  <p className={`text-sm lg:text-base ${textColorClasses} leading-relaxed text-left`}>
                    {displayText}
                  </p>
                </motion.div>
                ...
                <div className={`col-span-3 h-px w-full ${backgroundColor === 'black' ? 'bg-gray-700' : 'bg-gray-300'} my-2`}></div>
                ...
                >
                  <div className="grid grid-cols-2 gap-4 w-full text-left">
                    <div className={`text-[10px] ${textColorClasses} opacity-80 leading-tight`}>
                      <div className="font-bold text-[10px]">Aufbau a</div>
                      <div className="text-[10px]">Holzlattung Lärche Natur 5x4cm</div>
                      <div className="text-[10px]">ALU Traglattung 2,5cm + 2,0cm Abstandhalter</div>
                      <div className="text-[10px]">Foliendach UV-beständig RAL9005</div>
                    ...
                    <div className={`text-[10px] ${textColorClasses} opacity-80 leading-tight`}>
                      ...
                      <div className="text-[10px]">Sparren FJI 9x32cm + Steico Holzfaserdämmung</div>
                      <div className="text-[10px]">OSB NF 1,8cm</div>
                      <div className="text-[10px]">Install-Ebene 5,0cm</div>
                      <div className="text-[10px]">3-Schichtplatte Fichte sicht 1,9cm</div>
                    </div>
                  </div>
                </motion.div>
                <motion.div
                ...
                >
                  <div className="grid grid-cols-2 gap-4 w-full text-left">
                    <div className={`text-[10px] ${textColorClasses} opacity-80 leading-tight`}>
                      ...
                      <div className="text-[10px]">Parkett Eiche - Schwimmend verlegt</div>
                      <div className="text-[10px]">Flies Unterlegbahn 0,2cm</div>
                      <div className="text-[10px]">OSB 2,2cm</div>
                      <div className="text-[10px]">FJI Träger 36,0/8,9cm</div>
                      <div className="text-[10px]">Steico Holzfaserdämmung</div>
                      <div className="text-[10px]">H2O Zementfaserplatte 1,25cm</div>
                    </div>
                    <div className={`text-[10px] ${textColorClasses} opacity-80 leading-tight`}>
      ...
      {showInstructions && (
        <div className={`${containerClasses}`}>
          ...
          {isMobile ? (
            ...
            <p>Desktop layout: 3 columns with text {textPosition}, images {textPosition === 'left' ? 'center and right' : 'left and center'}</p>
          )}
          </div>
        </div>
      )}
