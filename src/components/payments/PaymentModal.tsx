  ...
  return (
    <div className="text-center py-8">
      ...
      <p className="text-gray-600 mb-8 text-lg">
        Vielen Dank! Ihre Zahlung über <strong>{formattedAmount}</strong> wurde erfolgreich
        verarbeitet und Ihre NEST-Haus Konfiguration ist jetzt bestätigt.
      </p>
      ...
      <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-6 mb-8 border border-green-200">
        <div className="text-sm space-y-3">
          <div className="flex justify-between items-center">
            ...
            <span className="font-mono text-xs bg-white px-2 py-1 rounded border">{paymentIntentId}</span>
          </div>
          <div className="flex justify-between items-center">
            <span className="text-gray-700 font-medium">Betrag:</span>
            <span className="text-green-700 font-bold text-lg">{formattedAmount}</span>
          </div>
          <div className="flex justify-between items-center">
          ...
          <div className="flex justify-between items-center">
            ...
            <span className="text-gray-600">{new Date().toLocaleDateString('de-DE')}</span>
          </div>
        </div>
      </div>
      ...
      <div className="bg-blue-50 rounded-xl p-6 mb-8 border border-blue-200">
        ...
        <div className="space-y-3 text-sm text-blue-800">
          <div className="flex items-start">
            ...
            <span><strong>Bestätigungsmail gesendet</strong> - Prüfen Sie Ihr E-Mail-Postfach</span>
          </div>
          <div className="flex items-start">
            <svg className="w-5 h-5 text-blue-500 mr-3 mt-0.5 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
              <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clipRule="evenodd" />
            </svg>
            <span><strong>Kontaktaufnahme innerhalb 24h</strong> - Unser Team meldet sich bei Ihnen</span>
          </div>
          <div className="flex items-start">
            ...
            <span><strong>Konfiguration in Bearbeitung</strong> - Ihre Planung wird vorbereitet</span>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="text-center text-sm text-gray-500">
          ...
          <div className="flex justify-center space-x-4 mt-2">
            <a href="mailto:info@nest-haus.at" className="text-blue-600 hover:text-blue-800 flex items-center">
              📧 info@nest-haus.at
            </a>
            <a href="tel:+43123456789" className="text-blue-600 hover:text-blue-800 flex items-center">
              📞 +43 123 456 789
            </a>
          </div>
        </div>
    ...
    <div className="text-center py-8">
      ...
      <div className="text-center text-sm text-gray-500 bg-gray-50 rounded-lg p-4">
        ...
        <div className="space-y-1">
          <p>📧 <a href="mailto:support@nest-haus.at" className="text-blue-600 hover:text-blue-800">support@nest-haus.at</a></p>
          <p>📞 <a href="tel:+43123456789" className="text-blue-600 hover:text-blue-800">+43 123 456 789</a></p>
          <p className="text-xs text-gray-400 mt-2">Montag - Freitag: 9:00 - 17:00 Uhr</p>
        </div>
      </div>
    </div>
  );
