...
/**
 * Buttons configuration for Partners section
 */
export const PARTNERS_BUTTONS = [
    {
        text: "Warum NEST?",
        variant: "primary" as const,
        size: "xs" as const,
...
/**
 * Complete preset configuration for Partners section
 */
export const PARTNERS_PRESET = {
    partners: PARTNERS_DATA,
    buttons: PARTNERS_BUTTONS,
};
