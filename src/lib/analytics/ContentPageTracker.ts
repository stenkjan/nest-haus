 ...
 * 
 * Tracks user interactions on content pages (warenkorb, kontakt, dein-hoam, entwurf, hoam-system)
...
export interface ContentPageSession {
    sessionId: string;
    pageType: 'warenkorb' | 'kontakt' | 'dein-hoam' | 'entwurf' | 'hoam-system' | 'warum-wir';
    startTime: number;
    endTime?: number;
