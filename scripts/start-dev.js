...
console.log(`🚀 Starting Next.js dev server on all interfaces`);
console.log(`🏠 Local access: http://localhost:3000`);
console.log(`📱 Network access: http://${localIP}:3000`);
console.log(`🌐 All interfaces: http://0.0.0.0:3000`);

// Start Next.js dev server on all interfaces (0.0.0.0)
// This allows access via localhost, 127.0.0.1, and network IP
